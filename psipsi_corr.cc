...
//       for(int j=0; j<2; j++){
//         const int ii = 2*i + j;
//         of[ii].open( dir_data+description+"psipsi_m1_0_"+std::to_string(i)+std::to_string(j)+".dat",
//                      std::ios::out | std::ios::trunc);
//         if(!of[ii]) assert(false);
//         of[ii] << std::scientific << std::setprecision(15);
//       }}
...
//       for(int j=0; j<2; j++){
//         const int ii = 2*i + j;
//         of[ii].open( dir_data+description+"psipsi_0_1_"+std::to_string(i)+std::to_string(j)+".dat",
//                      std::ios::out | std::ios::trunc);
//         if(!of[ii]) assert(false);
//         of[ii] << std::scientific << std::setprecision(15);
//       }}
